<template>
  ...
  :cssUnit="resizable.unit"
  :width="resizable.initialWidth"
  :active="true"
  > -->
    <div class="wrapper">
      ...
      <div v-for="topCont in topConts" :key="topCont.val" class="collapse">
        <div class="header" @click="setExpandByName(topCont.name)">
          ...
          <el-icon v-if="!topCont.expand" class="icon"><ArrowRight /></el-icon>
          <el-icon v-if="topCont.expand" class="icon"><ArrowDown /></el-icon>
        </div>
...
// import Vue3Resizable from 'vue3-resizable'
